  ...
  return (
    ...
    <section className="text-gray-600 body-font">
      <div className="max-w-5xl pt-52 pb-24 mx-auto">
        <h1 className="text-80 text-center font-4 lh-6 ld-04 font-bold text-teal-600 mb-6">
          Lorem ipsum
        </h1>
        <h2 className="text-2xl font-4 font-semibold lh-6 ld-04 pb-11 text-teal-400 text-center">
      ...
      <div className="pt-12 pb-24 max-w-4xl mx-auto fsac4 md:px-1 px-3">
        <div className="ktq4">
          ...
          <h3 className="pt-3 font-semibold text-lg text-teal-600">
            Lorem ipsum dolor sit amet
          </h3>
          <p className="pt-2 value-text text-md text-teal-200 fkrr1">
