...
function App() {
  ...
  return (
    <div className="text-teal-600 bg-[#E63946]">
    <Header />
    <section className="text-gray-600 body-font">
      <div className="max-w-5xl pt-52 pb-24 mx-auto">
        ...
        <h2 className="text-2xl font-4 font-semibold lh-6 ld-04 pb-11 text-black-400 text-center">
          To get started with today's Wordle, simply connect your wallet to play. <br />
        </h2>
        ...
        { account ?<div className="ml-6 text-center py-3 font-semibold text-black transition duration-500 ease-in-out transform bg-transparent bg-white px-7 text-md md:mt-0 hover:text-black hover:bg-white focus:shadow-outline">
      ...
      <p className="mx-auto text-xl text-center text-gray-300 font-normal leading-relaxed fs521 lg:w-2/3">
        By minting your Wordle result on the blockchain, it directly helps one of these great charities:
      </p>
      <div className="pt-12 pb-24 max-w-4xl mx-auto fsac4 md:px-1 px-3">
        <div className="ktq4">
          ...
          <p className="pt-2 value-text text-md text-[#F1FAEE] fkrr1">
           This is where information regarding the organization/charity goes. For now, this is simply placeholder text, as we are waiting to hear back from a few educational charities. 

           As such, this is just to function as a section placeholder until the project moves closer to completion.
