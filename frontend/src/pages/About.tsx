      ...
      <div className="pt-12 pb-24 max-w-4xl mx-auto fsac4 md:px-1 px-3">
        <div className="ktq4">
          ...
          <p className="pt-2 value-text text-md text-[#FFFFFF] fkrr1">
            This is a section in which we can fill out with a little bit about
            ourselves. Lorem ipsum, dolor sit amet consectetur adipisicing elit.
            Eveniet quas sed consequuntur molestiae maiores eos excepturi sequi,
            dicta delectus dolores earum dolore. Quas modi laborum, quae libero
            ab culpa molestiae!
          </p>
        </div>
        <div className="ktq4">
