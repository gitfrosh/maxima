    ...
    <>
      ...
      <div className="pt-12 pb-24 max-w-4xl mx-auto fsac4 md:px-1 px-3">
        ...
        <div className="ktq4">
          ...
          <h3 className="pt-3 font-bold text-lg text-[#FFFFFF]">Brenda Mejia</h3>
          <p className="pt-2 value-text text-md text-[#FFFFFF] fkrr1">
          A Computer Engineering student who enjoys learning about Blockchain Technology, DataScience, and Cybersecurity. 
          She currently teaches other young engineers and college students how to code and loves bringing others into the world of STEM.
          Hiking, exploring new cities, and making vegan food are some of her hobbies.   
          </p>
        </div>
      </div>
    </>
